...
namespace Laplace.Framework.Orm
{
	...
	public class SQLiteHelper
	{
        ...
        {
            var cmd =new SQLiteCommand(sql) {CommandType = CommandType.Text};
            return ExecuteNonQuery(connectionString, sql, cmd);
        }
        
        public static int ExecuteNonQuery(string connectionString, string sql, SQLiteCommand cmd)
        {
            int result = 0;
        ...
        public static int ExecuteNonQuery(string commandText,SQLiteParameter[] cmdParms)
        {
            return ExecuteNonQuery(ConnectionString, commandText, CommandType.Text, cmdParms);
        }
        /// <summary>
        /// 执行数据库操作(新增、更新或删除)
        /// </summary>
        ...
        {
            var cmd = new SQLiteCommand(sql) { CommandType = CommandType.Text };
            return ExecuteReader(ConnectionString, cmd);
        }
        /// <summary>
        ...
        {
            var cmd = new SQLiteCommand(commandText) { CommandType = CommandType.Text };
		...
		public static SQLiteParameterCollection DeriveParameters(string commandText,object[] paramList)
		{
		    ...
		    return null;
		    //var coll = new SQLiteParameterCollection();
