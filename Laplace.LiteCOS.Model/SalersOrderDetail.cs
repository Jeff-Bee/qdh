...
namespace Laplace.LiteCOS.Model
{
    ...
    /// 卖家线下销售单明细
    /// </summary>
    public class SalersOrderDetail : BaseModel
    {
        /// <summary>
    ...
    public class SalersOrderDetailMapper : ClassMapper<SalersOrderDetail>
    {
        public SalersOrderDetailMapper()
        {
            Table("SalersOrderDetail");
